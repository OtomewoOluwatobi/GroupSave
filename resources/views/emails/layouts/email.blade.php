...
<head>
    ...
    */
        ...
        .box {
            ...
            box-shadow: 0 4px 32px rgba(61, 43, 142, 0.08);
        }

        .hd {
            background: linear-gradient(135deg, #120f22, #1e1a38);
        ...
        .hd::before {
            ...
            width: 200px;
            height: 200px;
            background: radial-gradient(circle, rgba(200, 164, 90, 0.2), transparent 65%);
        }
        ...
        .hd::after {
            ...
            width: 160px;
            height: 160px;
            background: radial-gradient(circle, rgba(124, 92, 232, 0.12), transparent 65%);
        }
        ...
        .ic-violet {
            ...
            border: 1.5px solid rgba(124, 92, 232, 0.25);
        }
        ...
        .ic-dark {
            background: rgba(18, 15, 34, 0.08);
            border: 1.5px solid rgba(18, 15, 34, 0.15);
        }
        ...
        .ablock {
            text-align: center;
            padding: 28px 24px;
            background: linear-gradient(135deg, rgba(200, 164, 90, 0.07), rgba(124, 92, 232, 0.04));
        ...
        <blade media|(max-width%3A600px)%7B>.hd,
        .bd,
        .ft {
        ...
        <div class="box">
            ...
            @hasSection('icon')
                <div class="banner">
                    ...
                    <blade
                        hasSection|(%26%2339%3Bsubtitle%26%2339%3B)%3Cp%20class%3D%26%2334%3Besub%26%2334%3B%3E%40yield(%26%2339%3Bsubtitle%26%2339%3B)%3C%2Fp%3E%40endif>
                </div>
            @endif
