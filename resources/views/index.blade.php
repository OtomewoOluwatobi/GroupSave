...
<head>
    ...
    <!-- Preconnect + non-blocking font load -->
    <link rel="preconnect" href="https://fonts.bunny.net" crossorigin>
    <link rel="dns-prefetch" href="https://fonts.bunny.net">
    <link rel="preload" as="style" href="https://fonts.bunny.net/css?family=neue-montreal:400,500,600,700,800&display=swap" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://fonts.bunny.net/css?family=neue-montreal:400,500,600,700,800&display=swap"></noscript>
    <!-- Inline early-theme script: sets data-theme before first paint to prevent FOUC -->
    <script>(function(){try{var t=localStorage.getItem('gs-theme')||(window.matchMedia('(prefers-color-scheme:dark)').matches?'dark':'light');document.documentElement.setAttribute('data-theme',t);}catch(e){}})();</script>
    <style>
        *,
        *::before,
        *::after {
    ...
    ══════════════════════════════════════ */
        :root {
            ...
            --green-bright: #4ade80;
            --trans: background 0.45s cubic-bezier(.4,0,.2,1), color 0.45s cubic-bezier(.4,0,.2,1), border-color 0.45s cubic-bezier(.4,0,.2,1), opacity 0.45s cubic-bezier(.4,0,.2,1), transform 0.45s cubic-bezier(.4,0,.2,1);
        }
    ...
    ══════════════════════════════════════ */
        ...
        .blob-3 {
            width: 300px;
            height: 300px;
            background: radial-gradient(circle, rgba(30, 122, 80, 0.14), transparent 70%);
            top: 45%;
            right: 28%;
...
<body>
        ...
        <div class="hero-inner">
            ...
            <div class="hero-visual">
                ...
                <div class="mini-card mc-1">
                    ...
                    <div class="mc-val" style="color:#4ade80;">+£2,100</div>
        ...
        <div class="testi-grid">
            <div class="testi-card reveal" style="transition-delay:.05s">
                ...
                <div class="testi-foot">
                    <div class="tav" style="background:#667eea;">AN</div>
                    <div>
    ...
    <script>
        ...
        // Theme already applied by inline head script; sync JS state only
        ...
        // ══════════════════════════════════════
        // CUSTOM CURSOR (skipped on touch/mobile)
        // ══════════════════════════════════════
        const isTouchDevice = ('ontouchstart' in window) || (navigator.maxTouchPoints > 0) || (innerWidth < 1000);
        ...
        // ══════════════════════════════════════
        // PARTICLE CANVAS — skip on mobile & reduced-motion
        // ══════════════════════════════════════
        ...
        function drawParticles(now = 0) {
            if (!pageVisible || reducedMotion || isTouchDevice) return;
        ...
        // ══════════════════════════════════════
        // BLOB PARALLAX — rAF-throttled, passive, skipped on touch
        // ══════════════════════════════════════
            ...
            window.addEventListener('mousemove', e => {
                ...
                if (!blobTicking) {
                    ...
                    requestAnimationFrame(() => {
                        const x = (blobX / innerWidth - .5) * 30,
                            y = (blobY / innerHeight - .5) * 22;
                        blob1.style.transform = `translate(${x*.45}px,${y*.45}px)`;
                        blob2.style.transform = `translate(${-x*.3}px,${-y*.3}px)`;
                        blob3.style.transform = `translate(${x*.2}px,${y*.2}px)`;
                        blobTicking = false;
                    });
                }
            }, { passive: true });
