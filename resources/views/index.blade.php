...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400&family=Syne:wght@400;600;700;800&display=swap"
        rel="stylesheet">
    <style>
        *,
        *::before,
    ...
    ══════════════════════════════════════ */
        ...
        .price-card:nth-child(1) .price-illustration {
            background: radial-gradient(ellipse at 50% 80%, rgba(74, 222, 128, 0.12) 0%, transparent 65%);
        }

        .price-card.featured .price-illustration {
            background: radial-gradient(ellipse at 50% 80%, rgba(200, 164, 90, 0.16) 0%, transparent 65%);
        }

        .price-card:nth-child(3) .price-illustration {
            background: radial-gradient(ellipse at 50% 80%, rgba(124, 92, 232, 0.14) 0%, transparent 65%);
        }
